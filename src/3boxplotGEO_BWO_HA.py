...
def GEO_BWO():
    ...
    for j in range(100):    
        ...
        print(rpd) 
        if rpd < 1.1:
            np.savez("results_GEO-BWO-HA.npz", fitness_histories=fitness_histories)
            ...
            # Guardar como Excel
            with pd.ExcelWriter("results_GEO-BWO-HA.xlsx", engine="xlsxwriter") as writer:
            ...
            grafi = gr.graficos(fitness_histories, MaxIterations, "GEO_BWO_HA")
